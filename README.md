...
## How to build
 ...
 - cd into a days directory i.e. cd Day_1
 - mkdir build
 - cd build
 - cmake ..
 - cmake --build .
...
After build is complete, from inside the build directory
 - cd bin
 - ./{dayName} i.e. ./day_one path/to/input/file.txt
...
Day 5 instructions can be found [here](https://adventofcode.com/2024/day/5)

## Day Six

Day 6 instructions can be found [here](https://adventofcode.com/2024/day/6)